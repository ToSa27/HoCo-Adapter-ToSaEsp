...
#define TOSAESP_INPUTS   2
byte inputPin[TOSAESP_INPUTS] = { 0, 14 };
byte inputTrigger[TOSAESP_INPUTS] = { CHANGE, CHANGE };
byte inputType[TOSAESP_INPUTS] = { INPUT, INPUT };
unsigned int inputDebounce[TOSAESP_INPUTS] = { 250, 250 };
