...
# Customized 2017-06-05 by Tobias Hoff for HoCo
#
...
def main(args):
  ...
  rc = 1
  while rc != 0:
    rc = serve(options.esp_ip, options.host_ip, options.esp_port, options.host_port, options.auth, options.image, command)
  return rc
# end main
